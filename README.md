...
│   ├── context.gen.yaml        ← generated by `fac sync-context` (gitignored)
│   └── runs/                   ← pipeline run artifacts, one dir per run (gitignored)
│       └── 2026-07-24-abc/
│           ├── 00-discover.md
│           ├── 01-plan.md
...
│           └── 06-deploy.md
├── .agents/
│   └── project-context.yaml    ← alias of the merged context (gitignored)
